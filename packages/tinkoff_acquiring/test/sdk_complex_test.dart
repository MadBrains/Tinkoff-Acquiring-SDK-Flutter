...
Future<void> main() async {
  group('SDK Complex Tests', () {
    ...
    setUp(() async {
      ...
      await acquiring.removeCustomer(
    ...
    test(
      'complex',
      () async {
        final AddCustomerResponse addConsumer = await acquiring.addCustomer(
          AddCustomerRequest(
            customerKey: customerKey,
            email: email,
            phone: phone,
        ...
        final GetCustomerResponse getCustomer = await acquiring.getCustomer(
          GetCustomerRequest(
            customerKey: customerKey,
            ip: ip,
          ),
        ...
        final AddCardResponse addCard = await acquiring.addCard(
          AddCardRequest(
            customerKey: customerKey,
        ...
        final AttachCardResponse attachCard = await acquiring.attachCard(
          AttachCardRequest(
        ...
        final GetCardListResponse getCardList = await acquiring.getCardList(
          GetCardListRequest(
            customerKey: customerKey,
            ip: ip,
          ),
        ...
        final InitResponse init2 = await acquiring.init(
          InitRequest(
            orderId: (orderId +
                    math.Random(DateTime.now().millisecondsSinceEpoch)
                        .nextInt(100000))
        ...
        final CancelResponse cancel = await acquiring.cancel(
          CancelRequest(
        ...
        final InitResponse init3 = await acquiring.init(
          InitRequest(
            orderId: (orderId +
                    math.Random(DateTime.now().millisecondsSinceEpoch)
                        .nextInt(100000))
        ...
        final InitResponse init4 = await acquiring.init(
          InitRequest(
            orderId: (orderId +
                    math.Random(DateTime.now().millisecondsSinceEpoch)
                        .nextInt(100000))
        ...
        final InitResponse init5 = await acquiring.init(
          InitRequest(
            orderId: (orderId +
                    math.Random(DateTime.now().millisecondsSinceEpoch)
                        .nextInt(100000))
        ...
        final GetQrResponse qr = await acquiring.getQr(
          GetQrRequest(
        ...
        final GetStaticQrResponse staticQr = await acquiring.getStaticQr(
          GetStaticQrRequest(
            dataType: DataType.payload,
          ),
        );
